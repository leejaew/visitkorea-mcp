"""MCP schema for incremental sync."""
from mcp.types import Tool

TOOLS = [Tool(name="get_sync_list", description=(
    ...
    "showflag": {"type": "string", "description": "Filter by display flag: '1'=displayed, '0'=hidden. Omit for all.", "enum": ["0", "1"]},
    "arrange": {"type": "string", "description": "Sort: A=title, C=modified, D=created. With images: O/Q/R", "enum": ["A", "C", "D", "O", "Q", "R"]},
    "contentTypeId": {"type": "string", "description": "Filter by type: 75=Leisure, 76=Attraction, 78=Cultural, 79=Shopping, 80=Stay, 82=Food, 85=Event", "enum": ["75", "76", "78", "79", "80", "82", "85"]},
