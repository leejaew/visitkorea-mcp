"""MCP schemas for area, location, and keyword search."""
...
TOOLS = [
    Tool(name="search_tourism_by_area", description=(
        ...
        "arrange": {"type": "string", "description": "Sort: A=title, C=modified (newest first), D=created. With images only: O/Q/R", "enum": _ARRANGE_ENUM},
        "contentTypeId": {"type": "string", "description": _CONTENT_TYPE_DESC, "enum": _CONTENT_TYPE_ENUM},
        "lDongRegnCd": {"type": "string", "description": "Province code. Use get_legal_district_codes to look up. Example: '11'=Seoul, '26'=Busan"},
        "lDongSignguCd": {"type": "string", "description": "City/county code (requires lDongRegnCd). Use get_legal_district_codes to look up."},
    ...
    Tool(name="search_tourism_by_location", description=(
    ...
    Tool(name="search_tourism_by_keyword", description=(
