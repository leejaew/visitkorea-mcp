"""MCP schemas for tourism detail endpoints."""
from mcp.types import Tool

_CONTENT_TYPE_DESC = "75=Leisure, 76=Attraction, 78=Cultural, 79=Shopping, 80=Stay, 82=Food, 85=Event"
_CONTENT_TYPE_ENUM = ["75", "76", "78", "79", "80", "82", "85"]
_YN_ENUM = ["Y", "N"]

TOOLS = [
    Tool(name="get_tourism_common_info", description=(
        ...
        "contentId": {"type": "string", "description": "Numeric content ID string from a search result (e.g. '264337'). Must come from an active search call — do not guess."},
        "contentTypeId": {"type": "string", "description": "Optional. Content type of the item — pass when known from the search result. " + _CONTENT_TYPE_DESC, "enum": _CONTENT_TYPE_ENUM},
    ...
    Tool(name="get_tourism_intro_info", description=(
    ...
    Tool(name="get_tourism_detail_info", description=(
    ...
    Tool(name="get_tourism_images", description=(
        ...
        "numOfRows": {"type": "integer", "description": "Results per page (default 10)", "default": 10},
        "pageNo": {"type": "integer", "description": "Page number (default 1)", "default": 1},
        "imageYN": {"type": "string", "description": "Y=venue images (default), N=food/menu images (restaurants only)", "enum": _YN_ENUM},
    }, "required": ["contentId"]}),
]
