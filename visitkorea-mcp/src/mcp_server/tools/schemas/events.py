"""MCP schema for festival and event search."""
from mcp.types import Tool

TOOLS = [Tool(name="search_festivals_and_events", description=(
    ...
    "eventStartDate": {"type": "string", "description": "Event start date in YYYYMMDD format. Required. Example: '20260101'"},
