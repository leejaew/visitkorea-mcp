"""MCP schemas for reference code lookup endpoints."""
from mcp.types import Tool

_TYPES = ["75", "76", "78", "79", "80", "82", "85"]
_ARRANGE = ["A", "C", "D", "O", "Q", "R"]
TOOLS = [
    Tool(name="get_legal_district_codes", description=(
    ...
    Tool(name="get_classification_codes", description=(
    ...
    Tool(name="get_area_codes", description=(
    ...
    Tool(name="get_category_codes", description=(
        ...
        "contentTypeId": {"type": "string", "description": "Filter by content type: 75=Leisure, 76=Attraction, 78=Cultural, 79=Shopping, 80=Stay, 82=Food, 85=Event", "enum": _TYPES},
        "numOfRows": {"type": "integer", "description": "Results per page (default 100)", "default": 100},
        "pageNo": {"type": "integer", "description": "Page number (default 1)", "default": 1},
    }, "required": []}),
]